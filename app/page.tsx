...
export default function HomePage() {
  return (
    <div className="relative min-h-[calc(100vh-73px)] overflow-hidden px-6 py-12">
      ...
      <section className="mx-auto flex max-w-5xl flex-col items-center justify-center rounded-[2.5rem] border border-indigo-100 bg-white/80 px-6 py-12 text-center shadow-2xl shadow-indigo-950/10 backdrop-blur md:px-12 md:py-16">
        <DormExMark />

        <p className="mt-10 max-w-2xl text-lg leading-8 text-slate-600">
          面向学生和留学生的租房与转租平台。选择你的目标，直接开始。
        </p>
        ...
        <div className="mt-10 grid w-full max-w-3xl gap-5 md:grid-cols-2">
          ...
          >
            ...
            <p className="text-3xl font-bold">我要租房</p>
            <p className="mt-3 text-sm leading-6 text-slate-700">查看学校附近房源，筛选适合自己的转租或合租机会。</p>
            <span className="mt-6 inline-flex items-center gap-2 text-sm font-semibold text-cyan-800">
              进入找房 <ArrowRight size={16} className="transition group-hover:translate-x-1" />
            </span>
          </Link>
          ...
          >
            ...
            <p className="text-3xl font-bold">我要出租</p>
            <p className="mt-3 text-sm leading-6 text-slate-700">发布房源或转租信息，上传图片，等待审核后展示给租客。</p>
