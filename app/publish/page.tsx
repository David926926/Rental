    ...
    return (
      <div className="mx-auto max-w-3xl px-6 py-16">
        <div className="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm">
          <h1 className="text-3xl font-semibold text-slate-900">Log in before posting</h1>
          <p className="mt-3 leading-7 text-slate-600">Guests can browse listings, but only logged-in users can publish new ones.</p>
  ...
  return (
    <div className="mx-auto max-w-5xl px-6 py-12">
      <div className="mb-8">
        ...
        <h1 className="mt-3 text-4xl font-semibold text-slate-900">Post a Listing</h1>
        <p className="mt-3 max-w-3xl text-slate-600">
          Submitted listings enter review first and appear in the marketplace after approval.
        </p>
      </div>
